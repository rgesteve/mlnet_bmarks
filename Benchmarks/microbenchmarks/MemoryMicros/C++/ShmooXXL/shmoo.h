...
//
// shmoo.h : 
//      1. Defines some types used in shmoo.cpp        
//------------------------------------------------------------------
#include <stdio.h>
#include <tchar.h>
#include <stdlib.h>
...
extern "C" char *JIT_MemSet(unsigned char *dst, int value, unsigned count);
extern "C" void  JIT_MemCpy(void* _dest, const void *_src, size_t count);
